...
export const selectWeatherCityName = createSelector(
  selectWeatherData,
  (weatherData) => {
...
export const selectWeatherRegion = createSelector(
  selectWeatherData,
  (weatherData) => {
...
export const selectTwitchData = createSelector(
  selectTwitchRoot,
  (twitchRoot) => {
...
export const selectTwitchStreams = createSelector(
  selectTwitchData,
  (twitchData) => {
...
export const selectIsTwitchDataLoaded = createSelector(
  selectTwitchRoot,
  (twitchRoot) => {
